...
class PostSerializer(serializers.ModelSerializer):
    ...
    image_url = serializers.SerializerMethodField()
    images = PostImageSerializer(many=True, read_only=True)  # related_name='images' OK
    ...
    class Meta:
        ...
        fields = [
            ...
            'size', 'shoulder', 'chest', 'somae', 'chongjang',
    ...
    def get_image_url(self, obj):
        r = self.context.get('request')
        url = obj.uploaded_image.url if obj.uploaded_image else None
        return r.build_absolute_uri(url) if (r and url) else url
